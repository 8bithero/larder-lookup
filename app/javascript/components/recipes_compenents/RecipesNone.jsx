...
function RecipesNone() {
  return (
    <div className='text-center'>
      <svg
        className='mx-auto h-12 w-12 text-peach-sorbet mt-12'
        fill='none'
        viewBox='0 0 24 24'
        stroke='currentColor'
        aria-hidden='true'
      ...
      <h3 className='mt-2 text-sm font-semibold text-charcoal-slate'>No recipes</h3>
      <p className='mt-1 text-sm text-charcoal-slate'>Get started by searching for an ingredient.</p>
    </div>
  );
}

export default RecipesNone;
